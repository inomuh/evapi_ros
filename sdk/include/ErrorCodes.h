std::string GetErrorDescription(int i_error_code)
{
	...
	switch(i_error_code)
	{
		...
		case -132: str_error_description = "[Error Code 132] Evarobot: "; break;

		case -133: str_error_description = "[Error Code 133] Evarobot: "; break;

		case -134: str_error_description = "[Error Code 134] Evarobot: "; break;

		case -135: str_error_description = "[Error Code 135] Evarobot: "; break;

		case -136: str_error_description = "[Error Code 136] Evarobot: "; break;
